...
func newRootCmd() *cobra.Command {
	...
	cmd.AddCommand(newFetchCmd(), newFabricServeCmd(), newPublishCmd(), newSyncCmd(), newMigrateCmd(), newClaimCmd(), newAssignCmd(), newUpdateCmd(), newCloseCmd(), newQueueCmd(), newServeCmd())
	return cmd
}

func newFabricServeCmd() *cobra.Command {
	var relays []string
